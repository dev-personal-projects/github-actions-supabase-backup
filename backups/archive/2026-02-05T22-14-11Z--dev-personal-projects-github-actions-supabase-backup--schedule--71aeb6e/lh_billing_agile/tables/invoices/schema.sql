...
\restrict AhmHcLYK9G8bG6FAsAza560fcuF7KSkBareghf7QXAPS1dWvMWBqtuuwn2makw0
...
CREATE TABLE lh_billing_agile.invoices (
    ...
    CONSTRAINT ck_invoices__status CHECK ((status = ANY (ARRAY['draft'::text, 'ready_for_pdf'::text, 'generated'::text, 'sent'::text, 'failed_generate'::text, 'failed_send'::text, 'void'::text, 'dry_run'::text]))),
...
COMMENT ON COLUMN lh_billing_agile.invoices.status IS 'Lifecycle status: draft, ready_for_pdf, generated, sent, failed_generate, failed_send, void, dry_run';
...
\unrestrict AhmHcLYK9G8bG6FAsAza560fcuF7KSkBareghf7QXAPS1dWvMWBqtuuwn2makw0
