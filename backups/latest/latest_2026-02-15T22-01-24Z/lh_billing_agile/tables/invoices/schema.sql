...
\restrict M4MjVjLAa2BbZTutxtnNFDY3cG0qALwu9NeOjEaysH5c75umUWIgsKaT7VBbkpm
...
CREATE TABLE lh_billing_agile.invoices (
    ...
    CONSTRAINT ck_invoices__status CHECK ((status = ANY (ARRAY['draft'::text, 'ready_for_pdf'::text, 'generated'::text, 'sent'::text, 'failed_generate'::text, 'failed_send'::text, 'void'::text]))),
...
COMMENT ON COLUMN lh_billing_agile.invoices.status IS 'Lifecycle status: draft, ready_for_pdf, generated, sent, failed_generate, failed_send, void';
...
\unrestrict M4MjVjLAa2BbZTutxtnNFDY3cG0qALwu9NeOjEaysH5c75umUWIgsKaT7VBbkpm
